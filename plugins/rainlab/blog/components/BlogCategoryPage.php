...
class BlogCategoryPage extends ComponentBase
{
      /**
    ...
    public function onRun()
    {
        ...
        if($singlePost) {
            ...
            $nextSinglePost = BlogPost::where('id', $singlePost->id - 1)->orderBy('updated_at', 'DESC')->first();
            if($nextSinglePost) {
                $this->page['nextSinglePost'] = $nextSinglePost;
            }
        }
